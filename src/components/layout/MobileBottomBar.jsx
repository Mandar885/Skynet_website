...
export default function MobileBottomBar({ onCheckAvailability }) {
  return (
    ...
    >
      <a href="tel:+91 97669 78910" className="flex flex-col items-center gap-1 text-[var(--text-secondary)] hover:text-[var(--color-primary)] transition-colors">
        <FaPhone size={18} />
        <span className="text-[10px] font-medium">Call</span>
      </a>
      <a href="https://wa.me/919766978910" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 text-green-500 hover:text-green-400 transition-colors">
        <FaWhatsapp size={18} />
